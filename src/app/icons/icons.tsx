...
export const Icons = {
  nextjs: (props: IconProps) => (
    <svg
      ...
      className={`h-20 w-20" ${props.className}`}
      fill="currentColor"
      {...props}
    >
  ...
  react: (props: IconProps) => (
    <svg
      viewBox="0 0 24 24"
      xmlns="http://www.w3.org/2000/svg"
      className={`mr-1 h-[24px] w-[24px] text-neutral-300" ${props.className}`}
      fill="currentColor"
      {...props}
    >
  ...
  motion: (props: IconProps) => (
    <svg
      ...
      className={`fill-neutral-300" ${props.className}`}
      {...props}
    >
      <path
